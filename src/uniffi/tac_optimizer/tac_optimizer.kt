...
data class EggAssign (
    ...
    companion object {
        internal fun lift(rbuf: RustBuffer.ByValue): EggAssign {
            return liftFromRustBuffer(rbuf) { buf -> EggAssign.read(buf) }
        }

        internal fun read(buf: ByteBuffer): EggAssign {
            return EggAssign(
            String.read(buf),
            String.read(buf)
            )
